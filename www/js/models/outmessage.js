define([
    ...
    var OutmessageModel = Backbone.Model.extend({
        defaults: {
            messageId: 0,
            sender: '',
            title: '',
        ...
        getNext: function (currentKey) {
            ...
            request.onsuccess = function (e) {
                ...
                if (cursor) {
                    nextMessage = new OutmessageModel(cursor.value);
        ...
        getPrevious: function () {
            ...
            request.onsuccess = function (e) {
                ...
                if (cursor) {
                    previousMessage = new OutmessageModel(cursor.value);
